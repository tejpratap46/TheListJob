...
/*
 * https://github.com/runelaenen/TvDb-PHP-Class
...
class TvDb {
	...
	public function getSeriesById($serieId, $language = null) {
		$language = $language ?  : $this->defaultLanguage;
	...
	public function getSeriesByImdbId($serieId, $language = null) {
		$language = $language ?  : $this->defaultLanguage;
		
		$data = $this->fetchXml ( 'http://thetvdb.com/api/GetSeriesByRemoteID/?imdbid=' . $serieId );
