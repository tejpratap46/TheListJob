...
<body class="jumbotron">
    ...
    xmlhttp.open("GET", "ajax/episode.php?i=" + i + "&s=" +s + "&e=" + e, true);
    xmlhttp.send();
	}, 50);
	...
	function getImages(){
	    ...
	    xmlhttp.open("GET", "ajax/episodeimages.php?i=" + i + "&s=" +s + "&e=" + e, true);
	    xmlhttp.send();
	}
	...
	function getTrailer(){
	    ...
	    xmlhttp.open("GET", "ajax/episodevideo.php?i=" + i + "&s=" +s + "&e=" + e, true);
	    xmlhttp.send();
	}
	</script>
</body>
