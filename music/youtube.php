...
<body class="jumbotron">
	...
	<div class="container" style="width: 100%; margin-top: 70px;">
		...
		<div class="thumbnail center">
			<h1 class="bold">Youtube Music Lists</h1>
			<p>Music The Social Media Love's.</p>
		</div>
		<div class="jumbotron">
  ...
  $(window).scroll(function() {
	...
	function ajaxCall(p){
	    ...
	    xmlhttp.open("GET", "ajax/youtubeplaylist.php?list=" + q + "&start=" + p, true); // GET q is only used in billboard categories
	    xmlhttp.send();
	}
	</script>
</body>
